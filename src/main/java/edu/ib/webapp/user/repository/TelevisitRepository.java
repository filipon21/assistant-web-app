...
@Repository
public interface TelevisitRepository extends JpaRepository<Televisit, Long>, JpaSpecificationExecutor<Televisit> {
//    List<Televisit> findByUser_IdAndTelevisitStatusEnum(Long id, TelevisitStatusEnum televisitStatusEnum);
